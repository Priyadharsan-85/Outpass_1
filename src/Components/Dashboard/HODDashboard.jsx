 ...
 // Load requests from localStorage on mount
  ...
  const handleRequest = async (requestId, action) => {
    ...
    const request = currentRequests.approved.find(req => 
      ...
      req.approvalStatus?.hod === 'pending'
    );
    ...
    try {
        ...
        approved: currentRequests.approved.map(req => {
          if (req.requestId === requestId) {
            return {
              ...
              approvedBy: req.approvedBy + ', HOD',
              approvalStatus: {
                ...req.approvalStatus,
                hod: action === 'approve' ? 'approved' : 'rejected'
              }
            };
          }
          return req;
      ...
      await notifyRequestStatus(request, action, 'HOD');
          ...
          {(() => {
            ...
            if (tab === "pending") {
              ...
              filtered = requests.rejected.filter(req =>
                req.approvalStatus &&
                req.approvalStatus.hod === 'rejected'
              );
            }
  ...
  return (
    <div className="hod-dashboard">
      <div className="dashboard-header">
        <div>
          <h2>HOD Dashboard</h2>
          <p>Review and manage department outpass requests</p>
        </div>
